...
/////////////////////////////OSD start/////////////////////////////////////////////////////////////////////
#define MAIN_CHAN_OSD_PER_LINE_BYTES			7680	//max 7680. ��ͨ��ÿ���������ռ���ֽ���
#define SUB_CHAN_OSD_PER_LINE_BYTES				5760	//max 5760. ��ͨ��ÿ���������ռ���ֽ���
#define OSD_LINES								2		//����ʾOSD��������
#define MAIN_CHAN_OSD_BUFFER_SIZE				(MAIN_CHAN_OSD_PER_LINE_BYTES * OSD_LINES)	//��ͨ��OSD�������buffer
#define SUB_CHAN_OSD_BUFFER_SIZE				(SUB_CHAN_OSD_PER_LINE_BYTES * OSD_LINES)	//��ͨ��OSD�������buffer
#define OSD_UNICODE_CODES_NUM					100		//������ʾ�ַ���

#define OPAQUE_ALPHA							0		//��͸����alpha
#define CRYSTAL_CLEAR_ALPHA						15		//��ȫ͸����alpha

#define CRYSTAL_CLEAR_COLOR_TABLE_INDEX 		0		//��ȫ͸����color table
#define WHITE_COLOR_TABLE_INDEX 				1		//��ɫ��color table
#define BLACK_COLOR_TABLE_INDEX 				2		//��ɫ��color table

#define DEF_ALPHA								((OPAQUE_ALPHA + CRYSTAL_CLEAR_ALPHA) * 5 / 10)		//ȫ��alpha
#define DEF_1ST_FONTS_COLOR_TABLE_INDEX 		WHITE_COLOR_TABLE_INDEX			//��һ��������ɫ: ��ɫ
#define DEF_2ND_FONTS_COLOR_TABLE_INDEX 		WHITE_COLOR_TABLE_INDEX			//�ڶ���������ɫ: ��ɫ
#define DEF_1ST_GROUND_COLOR_TABLE_INDEX		BLACK_COLOR_TABLE_INDEX			//��һ�е�ɫ: ��ɫ
#define DEF_2ND_GROUND_COLOR_TABLE_INDEX		BLACK_COLOR_TABLE_INDEX			//�ڶ��е�ɫ: ��ɫ

#define MAIN_OSD_RELATIVE_OFFSET_X				24		//��ͨ��OSD���������ƫ��
#define MAIN_OSD_RELATIVE_OFFSET_Y				6
#define SUB_OSD_RELATIVE_OFFSET_X				16		//��ͨ��OSD���������ƫ��
...
int isp_init_param(int width, int height)
{
    ...
    ion_isp_mem = akuio_alloc_pmem(width*height*3/2*2);//����һ����3D������Ҫ
...
/*********** ircut ��ֵ�� ***************
	ircut��Ч : ircut_a=0, ircut_b=1
	ircut��Ч : ircut_a=1, ircut_b=0
	ircut���� : ircut_a=0, ircut_b=0
*/
...
static void camera_ircut_set(int ir_feed, int mode, char *name)
{
	if (mode == IRCUT_MODE_1LINE) {
        ...
        isp_exptime_max_set(); //�������õ�ǰ֡���µ��ع�ʱ��
        return ;
	}
...
static int fps_conf_info_init(void)
{
    ...
    //���Q��������õ���ƽ̨�汾���˴�������sensor�����֡��Ϊ25��һ�룬�������ȡ�ȽϺõ�ͼ��Ч����
    //ע�������13֡���������������Ƶ��ͬ����
    //�����Ҫ��֡�ʣ�����ע�͸�������»��25֡��
...
static void isp_exptime_max_set(void)
{
    ...
    //�˴�Ҫע��change_fps_thread�ܵ����������Ҫ�ȴ����ĳ�ʼ�����
...
void camera_do_save_yuv(void *pbuf, long size)
{
	...
	int save_yuv_fd = open("/tmp/isp_yuv.img", O_CREAT | O_APPEND | O_TRUNC | O_WRONLY,S_IRUSR|S_IWUSR);
	if(save_yuv_fd < 0) {
		perror("open");
		return;
	}
